...
enum nexus_action {
	...
	NEXUS_ACTION_SAVE        = NEXUS_ACT_SAVE,
	NEXUS_ACTION_THEME_NEXT  = NEXUS_ACT_THEME_NEXT,
	NEXUS_ACTION_THEME_PREV  = NEXUS_ACT_THEME_PREV,
	NEXUS_ACTION_HOST        = NEXUS_ACT_HOST,
};
