/*
 * 5x7 bitmap font, column-major, one byte per column (bit 0 = top row).
 * ASCII 32..90 (space .. 'Z'); lowercase folds to uppercase at draw time.
 *
 * 295 bytes for 59 glyphs, which is the entire type budget of the UI:
 * Section 102 asks for no Unicode font, Section 103 for bold uppercase
 * numerals, and integer scaling gives every size from this one table.
 *
 * SPDX-License-Identifier: MIT
 */
#ifndef NEXUS_FONT5X7_H
#define NEXUS_FONT5X7_H
...
static const uint8_t font5x7[(FONT_LAST - FONT_FIRST + 1) * FONT_W] = {
