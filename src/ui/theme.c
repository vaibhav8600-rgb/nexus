...
static const struct nexus_theme themes[] = {
	{
		...
		.wordmark = { NEXUS_C(0x0B0B16u), NEXUS_C(0xFFC2DCu),
			      NEXUS_C(0xFF5FA2u), NEXUS_C(0xC13FE0u),
			      NEXUS_C(0x7A1A55u) },
		.radius = 7,
	},
	{
		...
		.success = NEXUS_C(0x5CFFC0u), .warning = NEXUS_C(0xFFC24Du),
		.error = NEXUS_C(0xFF5F6Du),
		.wordmark = { NEXUS_C(0x000000u), NEXUS_C(0xFFC2DCu),
			      NEXUS_C(0xFF5FA2u), NEXUS_C(0xC13FE0u),
			      NEXUS_C(0x7A1A55u) },
		.radius = 7,
	},
	{
		...
		.wordmark = { NEXUS_C(0xE9EDF7u), NEXUS_C(0x8FA0F0u),
	...
	},
	{
		...
		.wordmark = { NEXUS_C(0x222634u), NEXUS_C(0x3F465Cu),
			      NEXUS_C(0xE86A9Au), NEXUS_C(0xA83C6Cu),
			      NEXUS_C(0x6B2244u) },
		.radius = 9,
	},
	{
		...
		.wordmark = { NEXUS_C(0x2A1C12u), NEXUS_C(0xFFD9A0u),
			      NEXUS_C(0xE9A23Bu), NEXUS_C(0xC07822u),
			      NEXUS_C(0x8A5414u) },
		.radius = 7,
	},
	{
		...
		.wordmark = { NEXUS_C(0x04150Eu), NEXUS_C(0xB8FFDCu),
	...
	},
	{
		...
		.wordmark = { NEXUS_C(0x2A0E1Eu), NEXUS_C(0xFFE9A8u),
			      NEXUS_C(0xFFB347u), NEXUS_C(0xFF6B8Bu),
			      NEXUS_C(0xB02A5Eu) },
		.radius = 7,
	},
};
